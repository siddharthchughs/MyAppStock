...
public class DateSelectedForStockActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_selected_for_stock);
...
//
        Intent in = new Intent(DateSelectedForStockActivity.this,UpdateActivity.class);
