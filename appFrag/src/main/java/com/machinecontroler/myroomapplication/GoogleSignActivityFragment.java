...
public class GoogleSignActivityFragment extends Fragment implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    public GoogleSignActivityFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signOut = (Button) v.findViewById(R.id.buttonSignout);
        ...
        Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(
                new ResultCallback<Status>() {
                    ...
                    public void onResult(Status status) {
                        ...
                        Toast.makeText(getContext(), "Logut Success", Toast.LENGTH_LONG).show();           }
                });
    }
