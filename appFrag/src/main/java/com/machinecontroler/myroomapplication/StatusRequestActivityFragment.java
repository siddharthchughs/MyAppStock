 ...
 */
public class StatusRequestActivityFragment extends Fragment {
    ...
    static final String URL_REFILL_BY_NAME = "http://nearesthospitals.in/SearchbyDate.php?";
    String name = null;

    private Intent in;

    public StatusRequestActivityFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_status_request, container, false);
...
//                    Display();
    ...
    public void Display() {
        ...
        if (isConnected()) {
            ...
            requestSearchClient(URL_REFILL_BY_NAME);
        }
    }
