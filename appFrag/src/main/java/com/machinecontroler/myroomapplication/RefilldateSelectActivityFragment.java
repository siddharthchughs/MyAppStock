 ...
 */
public class RefilldateSelectActivityFragment extends Fragment {
    ...
    static final String URL_REFILL_BY_DATE = "http://nearesthospitals.in/SearchbyDate.php?";
    String name=null;

    private Intent in;
    public RefilldateSelectActivityFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_refilldate_select, container, false);
      ...
      //  txtSearchdata = (TextView) v.findViewById(R.id.dataClient);
        ...
        selectDate = (Button) v.findViewById(R.id.dateSelect);
...
//      String formattedNow = simpleDateFormat.format(new Date());
     //   txtSearchdata.setMovementMethod(new ScrollingMovementMethod());
        ...
        mySearch = new ArrayList<>();
                ...
                String msg = in.getStringExtra("date");
...
//        Display();
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getContext(),DateSelectionActivity.class));
...
//                    Display();
    ...
    public void Display(String refillDate) {
        ...
        if (isConnected()) {
            ...
            requestSearchClient(URL_REFILL_BY_DATE,refillDate);
        }
    }
...
//        if(rv_SearchClientName.getAdapter().getItemCount()!=0) {
  ...
  //      }
    ...
    public void requestSearchClient(String uri,String refilldate) {

        Requestdata rd = new Requestdata();
        rd.setMethod("POST");
        rd.setUri(uri);
        rd.setParam("date", refilldate);
...
//                list.setClientUsing_Fragnance(obj.getString("Fragnance"));
    ...
    public class MyClientSearchAdapter extends RecyclerView.Adapter<MyClientSearchAdapter.MyHolder> {
        ...
        public MyHolder onCreateViewHolder(ViewGroup parent, int i) {
            ...
            View vw = inflater.inflate(R.layout.search_clientbydate, parent, false);
        ...
        public class MyHolder extends RecyclerView.ViewHolder {
            ...
            public MyHolder(View itemView) {
                ...
                categoryTitle = (TextView) itemView.findViewById(R.id.search_Title_date);
                //      mView = itemView;
            }
